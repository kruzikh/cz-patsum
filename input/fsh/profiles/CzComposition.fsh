...
Id: cz-CompositionPS
Title: "Composition (Czech Patient Summary)"
Description: """Clinical document used to represent the Czech Patient Summary (Czech PS) data set. 
The Czech Patient Summary (Czech PS) document is an electronic health record extract containing essential healthcare information about a subject of care. 
...
* ^purpose = "The Czech Patient Summary (Czech PS) document is an electronic health record extract containing essential healthcare information about a subject of care, comprising at least the required elements of the IPS dataset. The IPS dataset is minimal and non-exhaustive; specialty-agnostic and condition-independent; but still clinically relevant. As specified in EN 17269 and ISO 27269, it is designed for supporting the use case scenario for ‘unplanned, cross border care’, but it is not limited to it. It is intended to be international, i.e., to provide generic solutions for global application beyond a particular region or country."
* . ^short = "Czech Patient Summary composition"
* . ^definition = "Czech Patient Summary composition. \r\nA composition is a set of healthcare-related information that is assembled together into a single logical document that provides a single coherent statement of meaning, establishes its own context and that has clinical attestation with regard to who is making the statement. \r\nWhile a Composition defines the structure, it does not actually contain the content: rather the full content of a document is contained in a Bundle, of which the Composition is the first resource contained."
* text MS
* identifier MS
* status MS
...
* section[sectionMedications] ^short = "Czech Patient Summary Medication Summary Section"
...
// * section[sectionMedications].entry[medicationStatement] only Reference(CZ_MedicationStatementPS)
// * section[sectionMedications].entry[medicationStatement] ^sliceName = "medicationStatement"
// * section[sectionMedications].entry[medicationRequest] only Reference(CZ_MedicationRequestPS)
...
* section[sectionAllergies] ^short = "Czech Patient Summary Allergies and Intolerances Section"
...
// * section[sectionAllergies].entry[allergyOrIntolerance] only Reference(CZ_AllergyIntolerancePS)
// * section[sectionAllergies].entry[allergyOrIntolerance] ^sliceName = "allergyOrIntolerance"
...
* section[sectionProblems] ^short = "Czech Patient Summary Problems Section"
* section[sectionProblems] ^definition = "The Czech Patient Summary problem section lists and describes clinical problems or conditions currently being monitored for the patient."
...
// * section[sectionProblems].entry[problem] only Reference(CZ_ConditionPS)
...
* section[sectionProceduresHx] ^short = "Czech Patient Summary History of Procedures Section"
...
// * section[sectionProceduresHx].entry[procedure] only Reference(CZ_ProcedurePS)
// * section[sectionProceduresHx].entry[procedure] ^sliceName = "procedure"
// * section[sectionProceduresHx].entry[procedure] ^mustSupport = true
...
* section[sectionImmunizations] ^short = "Czech Patient Summary Immunizations Section"
...
// * section[sectionImmunizations].entry[immunization] only Reference(CZ_ImmunizationPS)
// * section[sectionImmunizations].entry[immunization] ^sliceName = "immunization"
// * section[sectionImmunizations].entry[immunization] ^mustSupport = true
...
* section[sectionMedicalDevices] ^short = "Czech Patient Summary Medical Devices Section"
...
// * section[sectionMedicalDevices].entry[deviceStatement] only Reference(CZ_DeviceUseStatementPS)
...
* section[sectionResults] ^short = "Czech Patient Summary Results Section"
...
// * section[sectionResults].entry[results-observation] only Reference(CZ_ObservationResultsPS)
...
// * section[sectionResults].entry[results-diagnosticReport] only Reference(CZ_DiagnosticReportPS)
...
* section[sectionVitalSigns] ^short = "Czech Patient Summary Vital Signs Section"
...
* section[sectionPastIllnessHx] ^short = "Czech Patient Summary History of Past Illness Section"
...
// * section[sectionPastIllnessHx].entry[pastProblem] only Reference(CZ_ConditionPS)
...
* section[sectionFunctionalStatus] ^short = "Czech Patient Summary Functional Status"
...
// * section[sectionFunctionalStatus].entry[disability] only Reference(CZ_ConditionPS)
...
* section[sectionPlanOfCare] ^short = "Czech Patient Summary Plan of Care Section"
...
* section[sectionSocialHistory] ^short = "Czech Patient Summary Social History Section"
...
* section[sectionSocialHistory].entry contains
    ...
    alcoholUse 0..1
* section[sectionSocialHistory].entry[smokingTobaccoUse] only Reference(CZ_ObservationTobaccoUsePS)
* section[sectionSocialHistory].entry[alcoholUse] only Reference(CZ_ObservationAlcoholUsePS)
...
* section[sectionPregnancyHx] ^short = "Czech Patient Summary History of Pregnancy Section"
...
// * section[sectionPregnancyHx].entry[pregnancyStatus] only Reference(CZ_ObservationPregnancyStatusPS)
// * section[sectionPregnancyHx].entry[pregnancyStatus] ^sliceName = "pregnancyStatus"
// * section[sectionPregnancyHx].entry[pregnancyOutcomeSummary] only Reference(CZ_ObservationPregnancyOutcomePS)
